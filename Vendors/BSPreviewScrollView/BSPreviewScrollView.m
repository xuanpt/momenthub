...
- (void)layoutSubviews
{
	...
	if(firstLayout)
	{
        ...
        [self changePage:_selectedPageIndex];
	}
}
...
-(void)scrollViewDidScroll:(UIScrollView *)sv {
    [sv setContentOffset: CGPointMake(sv.contentOffset.x, oldY)];
    ...
    [(ImageScrollView*)self.parentView updatePageControlIndex:page];
}
...
-(void)changePage:(int)pageIndex {
    ...
    [(ImageScrollView*)self.parentView updatePageControlIndex:pageIndex];
}
